...
export const NOTIFICATION_TYPES = [
  ...
  'BOOKING_CANCELLED',
  'BOOKING_REFUNDED',
  'BOOKING_REFUND_INVITATION',
  'BOOKING_REQUEST_CREATED',
  'BOOKING_GIFT_REQUEST_CREATED',
  'BOOKING_GIFT_APPROVED',
  'BOOKING_GIFT_REJECTED',
  'THEORY_PERSONAL_REQUEST_CREATED',
  'THEORY_PERSONAL_REQUEST_RECEIVED',
  'THEORY_PERSONAL_REQUEST_CONTACTED',
  'THEORY_PERSONAL_REQUEST_BOOKED',
  'THEORY_PERSONAL_REQUEST_CANCELLED',
  'LESSON_UPCOMING',
  'CONTACT_REQUEST_CREATED',
  'CALL_REQUEST_CREATED',
  'PAYMENT_RECEIVED',
  'BOOKING_PAYMENT_REMINDER',
  'BOOKING_AUTO_CANCELLED_PAYMENT',
  'PETROL_EXPENSE_REQUEST_CREATED',
  'PETROL_EXPENSE_REQUEST_APPROVED',
  'PETROL_EXPENSE_REQUEST_REJECTED',
  'SYSTEM_ALERT',
] as const;

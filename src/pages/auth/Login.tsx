  ...
  return (
    <div className="min-h-screen bg-background flex">
      <div className="hidden lg:flex lg:w-1/2 bg-hero flex-col justify-between p-12 relative overflow-hidden">
        ...
        <div className="relative">
          <blockquote className="text-2xl font-semibold text-hero-foreground leading-relaxed mb-6">
            {t("loginHeroQuote")}
          </blockquote>
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-hero-foreground font-medium text-sm">Ani K.</p>
              <p className="text-hero-foreground/70 text-xs">Licensed 2023 • Student</p>
            </div>
          </div>
        </div>
        ...
        <div className="w-full max-w-md">
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            <div>
              ...
              <Input type="email" value={email} onChange={e => setEmail(e.target.value)} placeholder={t("emailAddress")} className="h-11" />
            </div>
            <div>
          ...
          <p className="text-center text-sm text-muted-foreground mt-4">
            {t("noAccount")}{" "}
            <Link href="/register" className="text-primary font-medium hover:underline">{t("signUp")}</Link>
          </p>

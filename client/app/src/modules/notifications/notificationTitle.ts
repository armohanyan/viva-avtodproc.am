...
const TITLE_KEY: Record<NotificationType, TranslationKey> = {
  ...
  [NOTIFICATION_TYPE.BOOKING_GIFT_REQUEST_CREATED]: "notifTitleGiftBookingRequest",
  [NOTIFICATION_TYPE.BOOKING_GIFT_APPROVED]: "notifTitleGiftBookingApproved",
  [NOTIFICATION_TYPE.BOOKING_GIFT_REJECTED]: "notifTitleGiftBookingRejected",

...
import { branchDisplayLabel, branchMinimalLabel } from "src/modules/branches";
...
/** @deprecated Import from `src/modules/branches` instead. */
export { branchMinimalLabel, branchDisplayLabel };

...
export const adminRoutes: readonly AppRoute[] = [
  ...
  { path: "/admin/import-practical-xlsx", component: AdminImportPracticalXlsxPage, allowedAccountTypes: STAFF },
  ...
  { path: "/admin/finance/petrol-requests", component: AdminPetrolRequestsPage, allowedAccountTypes: SUPER_ADMIN_ONLY_ACCOUNT_TYPES },

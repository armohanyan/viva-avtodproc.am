...
/** Student rating analytics (chart + breakdown table) for use inside admin Students or a modal. */
export default function AdminUsersAnalyticsPanel() {
  const { t } = useLang();
  ...
  return (
    <Card className="border-border overflow-hidden">
      <div className="p-4 sm:p-5 border-b border-border/70 min-h-[240px]">
        <Bar

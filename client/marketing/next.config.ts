...
/** Load env from the marketing app root. */
...
const nextConfig: NextConfig = {
  ...
  output: "standalone",
  // Keep tracing scoped to the marketing app for independent deploys.
  ...
  /**
   * Mirror `app/vite.config.ts` server proxy so production `next start` works like Vite dev:
